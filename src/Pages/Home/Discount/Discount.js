...
const Discount = () => {
  return (
    <section className="grid grid-cols-2 gap-10 px-10 my-10 text-white">
      <div className="flex justify-between p-12 bg-warning ">
        <div className="font-mono text-2xl">
          <p className="uppercase font-bold">big sale countdown</p>
          <h3 className="font-bold text-6xl uppercase">hurry up!</h3>
          <p>Stock Limited</p>
        </div>
        <div className="text-black flex items-center text-6xl">
          <h3 className="text-8xl">75</h3>
          <span>
      ...
      <div className="flex justify-center items-center bg-black">
        <div className="border-4 border-warning p-7 font-bold font-mono text-center">
